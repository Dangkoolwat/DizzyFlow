...
| 2026-04-04 | Sanghyouk Jin / OpenAI ChatGPT | UX/UI 기준 문서 경로, Settings 구조, 현재 버전과 2.0 범위 구분, WorkflowPhase 확장 방향을 반영해 README 갱신 |
...
- 모델 관리 UX 구조 정의 완료
- Processing / Terminal States UX 정의 완료
...
코드 수준에서도 `WorkflowPhase`를 위 6단계 구조로 동기화하는 것을 목표로 한다.
